...
This is a dated snapshot preserved for project history. For current
implementation priorities, see [Roadmap](../developers/roadmap.md).
...
see [DEBUGGER_ROADMAP.md](../developers/reverse-engineering-roadmap.md); for the debugger architecture see
[DEBUGGER_DESIGN.md](../developers/debugger-design.md).
...
- **Direction** ([ARCHITECTURE.md](../developers/architecture.md)): the CPU foundations
  ...
  these foundations — see [SPECTRUM_DESIGN.md](../developers/spectrum-machine-design.md).
...
- **Designed, ready to implement:** the Spectrum ULA (screen via full-frame
  ...
  interrupt). See [ARCHITECTURE.md](../developers/architecture.md) and
  [SPECTRUM_DESIGN.md](../developers/spectrum-machine-design.md). Foundations land first: multi-observer
...
- **Later (roadmap):** L3 annotation knowledge base (comments, data typing,
  ...
  ([DEBUGGER_ROADMAP.md](../developers/reverse-engineering-roadmap.md)).
