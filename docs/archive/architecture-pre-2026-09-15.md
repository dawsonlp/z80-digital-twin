...
*Companion docs: [DEBUGGER_DESIGN.md](../developers/debugger-design.md) (debugger),
[SPECTRUM_DESIGN.md](../developers/spectrum-machine-design.md) (the Spectrum machine + ULA/PAL timing),
[DEBUGGER_ROADMAP.md](../developers/reverse-engineering-roadmap.md) (reverse-engineering vision),
