...
[observed disassembly checklist](docs/developers/observed-disassembly-checklist.md).
...
[address-based metadata developer checklist](docs/developers/address-metadata-checklist.md).
...
properties. This checklist is written; its implementation has not begun.

## Constraints and current direction

Implementation continuation: see the [ROM reverse-loop checklist](docs/developers/rom-reverse-loop-checklist.md)
...
See [the verification record](docs/testers/spectrum-development-loop-verification.md)
...
documented in [the architecture review](docs/developers/source-architecture-feedback.md).
...
[the development checklist](docs/developers/observed-disassembly-checklist.md).
