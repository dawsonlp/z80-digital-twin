...
([Architecture](../developers/architecture.md)); it runs over the same CPU as the debugger
([Debugger Design](../developers/debugger-design.md)) and is debuggable while running.
...
plug; see [Architecture](../developers/architecture.md) §5) powers the debugger's
